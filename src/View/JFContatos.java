...
public class JFContatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblContatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "CPF", "Rua", "CEP", "Cidade", "Número da casa", "Bairro", "Telefone"
            }
        ) {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if (!txtNome.getText().isEmpty() && !txtCPF.getText().isEmpty() && !txtRua.getText().isEmpty()) {
            DefaultTableModel dtm = (DefaultTableModel) tblContatos.getModel();
    ...
    private void tblContatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblContatosMouseClicked
        ...
        if (linhaSelecionada != -1) {
            ...
            txtCPF.setText(String.valueOf(dtm.getValueAt(linhaSelecionada, 2)));
            txtRua.setText(String.valueOf(dtm.getValueAt(linhaSelecionada, 3)));
            txtCEP.setText(String.valueOf(dtm.getValueAt(linhaSelecionada, 4)));
            txtCidade.setText(String.valueOf(dtm.getValueAt(linhaSelecionada, 5)));
            txtNumCasa.setText(String.valueOf(dtm.getValueAt(linhaSelecionada, 6)));
            txtBairro.setText(String.valueOf(dtm.getValueAt(linhaSelecionada, 7)));
            txtTelefone.setText(String.valueOf(dtm.getValueAt(linhaSelecionada, 8)));
        }
